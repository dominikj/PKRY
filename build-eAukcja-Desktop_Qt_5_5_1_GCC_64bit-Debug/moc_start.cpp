...
QT_MOC_LITERAL(1, 6, 7), // "uruchom"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 1), // "t"
QT_MOC_LITERAL(4, 17, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(5, 41, 21) // "on_pushButton_clicked"

    },
    "Start\0uruchom\0\0t\0on_pushButton_2_clicked\0"
...
void Start::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->uruchom((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            typedef void (Start::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Start::uruchom)) {
                *result = 0;
            }
        }
    }
